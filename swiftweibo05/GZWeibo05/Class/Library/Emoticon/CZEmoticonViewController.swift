...
//    
    ...
    */
    ...
    private func setupCollectionView() {
        ...
        // 注册cell
        collectionView.registerClass(CZEmoticonCell.self, forCellWithReuseIdentifier: collectionViewCellIdentifier)
...
extension CZEmoticonViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(collectionViewCellIdentifier, forIndexPath: indexPath) as! CZEmoticonCell
...
//        collectionView.reloadSections(NSIndexSet(index: indexPath.section))
        ...
        if indexPath.section != 0 {
            // 添加 表情模型 到  最近表情包
            CZEmoticonPackage.addFavorate(emoticon)
        }
...
//    /// 添加表情到textView
//    private func insertEmoticon(emoticon: CZEmoticon) {
